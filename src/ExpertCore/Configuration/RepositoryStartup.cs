...
using Expert.Domain.Repositories.Interfaces;
using Expert.Infrastructure.Data.Repositories;
...
public static class RepositoryStartup
{
    public static IServiceCollection AddRepositoryModule(this IServiceCollection services)
    {
        ...
        services.Scan(scan => scan
            ...
            .AddClasses(classes => classes.InNamespaces("Expert.Infrastructure.Data.Repositories"))
            ...
            .AddClasses(classes => classes.Where(type => type.Namespace.Equals("Expert.Infrastructure.Data.Repositories") &&
